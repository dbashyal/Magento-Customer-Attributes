...
class Technooze_Tcustomerattributes_Block_Adminhtml_Grid  extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();      
      $this->setId('tcustomerattributesgrid');
      $this->setDefaultSort('attribute_code');
      $this->setDefaultDir('ASC');
      $this->setSaveParametersInSession(true);
      $this->setTemplate('tcustomerattributes/grid.phtml');
  }
  ...
  protected function _prepareColumns()
  {
      $this->addColumn('attribute_code', array(
		...
		$this->addExportType('*/*/exportCsv', Mage::helper('tcustomerattributes')->__('CSV'));
		$this->addExportType('*/*/exportXml', Mage::helper('tcustomerattributes')->__('XML'));
  ...
  public function addNewButton(){
  	return $this->getButtonHtml(
  		Mage::helper('tcustomerattributes')->__('New Attribute'), //label
